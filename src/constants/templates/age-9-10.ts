...
.s{background:linear-gradient(145deg,rgba(255,255,255,0.98),rgba(248,250,252,0.95));border-radius:15px;padding:25px;margin:20px auto;box-shadow:0 10px 25px rgba(0,0,0,0.08);position:relative;border:1px solid rgba(255,255,255,0.6);overflow-y:auto;overflow-x:hidden;max-height:90vh;min-height:200px;scroll-behavior:smooth;max-width:min(1600px,80%);width:100%}
...
.primary-image{width:400px;height:300px;border-radius:20px;border:4px solid rgba(255,255,255,0.9);box-shadow:0 15px 30px rgba(0,0,0,0.2);cursor:pointer;transition:all 0.3s ease;margin:20px auto;overflow:hidden;background:linear-gradient(135deg,#f0f9ff 0%,#e0f2fe 100%);display:flex;align-items:center;justify-content:center;position:relative;max-width:calc(100% - 40px);box-sizing:border-box}
...
.layout-fullscreen{width:100%;max-width:1200px;height:auto;min-height:calc(100vh - 40px);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:25px;margin:20px auto;box-sizing:border-box;overflow-y:auto;overflow-x:hidden;background:linear-gradient(145deg,rgba(255,255,255,0.98),rgba(248,250,252,0.95));border-radius:15px;box-shadow:0 10px 25px rgba(0,0,0,0.08);border:1px solid rgba(255,255,255,0.6)}
...
.template-section{margin:25px 0;padding:25px;background:rgba(255,255,255,0.1);border-radius:15px;border:2px dashed rgba(255,255,255,0.4);overflow-y:auto;overflow-x:hidden;max-height:80vh;min-height:200px;scroll-behavior:smooth}
...
.content-center{display:flex;flex-direction:column;align-items:center;justify-content:flex-start;min-height:100vh;padding:25px;width:100%;max-width:100%;box-sizing:border-box;overflow-x:hidden;overflow-y:auto;scroll-behavior:smooth}
.two-column{display:flex;align-items:flex-start;justify-content:space-between;max-width:1200px;margin:0 auto;gap:30px;padding:25px;width:100%;box-sizing:border-box;overflow-y:auto;overflow-x:hidden;max-height:80vh;min-height:300px;scroll-behavior:smooth}
.two-column .left-side,.two-column .right-side{flex:1;max-width:50%;box-sizing:border-box}
.three-column{display:grid;grid-template-columns:1fr 1fr 1fr;gap:20px;max-width:1200px;margin:0 auto;padding:25px;width:100%;box-sizing:border-box;overflow-y:auto;overflow-x:hidden;max-height:80vh;min-height:300px;scroll-behavior:smooth}
.content-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:15px;padding:20px;overflow-y:auto;overflow-x:hidden;max-height:75vh;min-height:300px;scroll-behavior:smooth}
...
.content-table{width:100%;border-collapse:collapse;margin:20px 0;background:rgba(255,255,255,0.95);border-radius:10px;overflow:hidden;box-shadow:0 5px 15px rgba(0,0,0,0.1)}
.content-table th,.content-table td{padding:12px 15px;text-align:left;border-bottom:1px solid rgba(0,0,0,0.1)}
...
.metric-value{font-size:32px;font-weight:700;color:#1F4E79;margin:10px 0}
.metric-label{font-size:16px;color:#2c3e50;font-weight:500}
...
@media (max-width:768px){.slide-title-main{font-size:28px}.main-heading{font-size:26px}.section-heading{font-size:20px}.slide-title-secondary{font-size:22px}.instruction-text{font-size:18px}.simple-text{font-size:16px}.primary-image{width:320px;height:240px}.s{padding:20px;margin:15px 0;max-height:none;overflow-y:visible}.template-section{padding:20px;margin:20px 0;max-height:none;overflow-y:visible}.two-column{flex-direction:column;gap:20px;max-height:none;overflow-y:visible}.three-column{grid-template-columns:1fr;gap:15px;max-height:none;overflow-y:visible}.content-grid{grid-template-columns:1fr;max-height:none;overflow-y:visible}.chart-container{max-height:none;overflow-y:visible}.metrics-grid{grid-template-columns:1fr 1fr}.metric-value{font-size:24px}.audio-toggle{width:70px;height:70px;font-size:35px}.audio-status{font-size:14px}}
@media (max-width:480px){.slide-title-main{font-size:24px}.main-heading{font-size:22px}.section-heading{font-size:18px}.slide-title-secondary{font-size:20px}.instruction-text{font-size:16px}.simple-text{font-size:14px}.primary-image{width:280px;height:210px}.s{padding:15px;margin:10px 0;max-height:none;overflow-y:visible}.template-section{padding:15px;margin:15px 0;max-height:none;overflow-y:visible}.card{padding:15px}.content-table th,.content-table td{padding:8px 10px;font-size:14px}.metric-card{padding:15px}.metric-value{font-size:20px}.metric-label{font-size:14px}.timeline-item{padding:15px 0 15px 30px}.tag{padding:4px 8px;font-size:12px}.alert{padding:12px}.audio-toggle{width:60px;height:60px;font-size:30px;top:15px;right:15px}.audio-status{font-size:12px;top:85px;right:15px}.metrics-grid{grid-template-columns:1fr}.button-row{gap:15px}.two-column{max-height:none;overflow-y:visible}.three-column{max-height:none;overflow-y:visible}.content-grid{max-height:none;overflow-y:visible}.chart-container{max-height:none;overflow-y:visible}}
</style>
</head>
<body>
...
<div class="primary-image" onclick="handleImageClick(this,'primary')" role="button" tabindex="0" aria-label="Hero image - educational scene">
