 ...
 */
export const AGE_2_3_DESCRIPTION = 'Interactive template for toddlers 2-3 years: large buttons, animations, optional sound effects (disabled by default), bright colors, and engaging visual feedback';
