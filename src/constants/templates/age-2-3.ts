...
.main-title{font-size:clamp(44px,12vw,72px);color:#FFFFFF;text-shadow:4px 4px 8px rgba(0,0,0,0.4);text-align:center;margin:clamp(20px,5vw,40px) 0;font-weight:bold;animation:title-bounce 2s infinite}
.secondary-title{font-size:clamp(32px,8vw,48px);color:#FFFFFF;text-shadow:3px 3px 6px rgba(0,0,0,0.3);text-align:center;margin:clamp(15px,4vw,30px) 0;font-weight:bold}
