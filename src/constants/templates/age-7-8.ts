...
.content-container{background:rgba(255,255,255,0.95);border-radius:20px;padding:30px;margin:20px 0;box-shadow:0 15px 35px rgba(0,0,0,0.1);border:2px solid rgba(255,255,255,0.5);min-height:100vh;max-height:none;display:flex;flex-direction:column;overflow-y:auto;overflow-x:hidden;scroll-behavior:smooth}
...
.template-section{margin:30px 0;padding:30px;background:rgba(255,255,255,0.1);border-radius:20px;border:2px dashed rgba(255,255,255,0.5);overflow-y:auto;overflow-x:hidden;max-height:85vh;min-height:200px;scroll-behavior:smooth}
...
.content-center{display:flex;flex-direction:column;align-items:center;justify-content:flex-start;min-height:100vh;padding:30px;width:100%;max-width:100%;box-sizing:border-box;overflow-x:hidden;overflow-y:auto;scroll-behavior:smooth}
.s{background:rgba(255,255,255,0.95);border-radius:15px;padding:25px;margin:20px 0;box-shadow:0 10px 25px rgba(0,0,0,0.08);position:relative;border:1px solid rgba(255,255,255,0.6);overflow-y:auto;overflow-x:hidden;max-height:90vh;min-height:200px;scroll-behavior:smooth}
.two-column{display:flex;align-items:flex-start;justify-content:space-between;max-width:1000px;margin:0 auto;gap:40px;padding:30px;width:100%;box-sizing:border-box;overflow-y:auto;overflow-x:hidden;max-height:85vh;min-height:300px;scroll-behavior:smooth}
...
[class*="round"] .image-container,[class*="circle"] .image-container,[class*="reward"] .image-container,[class*="profile"] .image-container{width:100%!important;height:100%!important;margin:0!important;padding:0!important;border-radius:50%!important;overflow:hidden!important;display:flex!important;align-items:center!important;justify-content:center!important;position:absolute!important;top:0!important;left:0!important;z-index:1!important;box-shadow:none!important}
[class*="round"] .image-container img,[class*="circle"] .image-container img,[class*="reward"] .image-container img,[class*="profile"] .image-container img{width:100%!important;height:100%!important;object-fit:cover!important;object-position:center!important;border-radius:0!important;box-shadow:none!important;margin:0!important;padding:0!important;max-width:none!important;display:block!important;border:none!important}
...
@media (max-width:768px){.slide-main-title{font-size:30px}.main-heading{font-size:26px}.section-heading{font-size:20px}.slide-title-secondary{font-size:24px}.instruction-text{font-size:20px}.simple-text{font-size:18px}.hero-image{width:320px;height:240px}.content-container{padding:20px;margin:10px 0}.template-section{padding:20px;margin:20px 0;max-height:none;overflow-y:visible}.two-column{flex-direction:column;gap:25px;max-height:none;overflow-y:visible}.s{padding:20px;max-height:none;overflow-y:visible}.audio-toggle{width:70px;height:70px;font-size:35px}.audio-status{font-size:14px}.reward-element{width:60px;height:60px;font-size:30px}[class*="round"] .image-container,[class*="circle"] .image-container,[class*="reward"] .image-container,[class*="profile"] .image-container{width:100%;height:100%}[class*="round"] .image-container img,[class*="circle"] .image-container img,[class*="reward"] .image-container img,[class*="profile"] .image-container img{width:100%;height:100%}}
@media (max-width:480px){.slide-main-title{font-size:24px}.main-heading{font-size:22px}.section-heading{font-size:18px}.slide-title-secondary{font-size:20px}.instruction-text{font-size:18px}.simple-text{font-size:16px}.hero-image{width:280px;height:210px}.content-container{padding:15px;margin:5px 0}.template-section{padding:15px;margin:15px 0;max-height:none;overflow-y:visible}.button-row{gap:15px}.audio-toggle{width:60px;height:60px;font-size:30px;top:15px;right:15px}.audio-status{font-size:12px;top:85px;right:15px}.reward-element{width:50px;height:50px;font-size:24px}[class*="round"] .image-container,[class*="circle"] .image-container,[class*="reward"] .image-container,[class*="profile"] .image-container{width:100%;height:100%}[class*="round"] .image-container img,[class*="circle"] .image-container img,[class*="reward"] .image-container img,[class*="profile"] .image-container img{width:100%;height:100%}.two-column{max-height:none;overflow-y:visible}.s{max-height:none;overflow-y:visible}}
</style>
</head>
<body>
