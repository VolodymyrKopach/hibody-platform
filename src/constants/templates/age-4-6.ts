...
.giant-button{width:min(320px,80vw);height:min(320px,80vw);max-width:320px;max-height:320px;min-width:180px;min-height:180px;border-radius:50%;border:min(10px,2vw) solid rgba(255,255,255,0.8);cursor:pointer;font-size:min(120px,18vw);color:white;font-weight:bold;transition:all 0.4s cubic-bezier(0.68,-0.55,0.265,1.55);position:relative;overflow:hidden;box-shadow:0 25px 50px rgba(0,0,0,0.3);background:linear-gradient(135deg,#5B9BD5 0%,#4A90E2 100%);animation:giant-pulse 3s infinite;display:flex;align-items:center;justify-content:center;outline:none;flex-shrink:0}
...
[class*="round"],[class*="circle"],[class*="interactive"],[class*="primary"]{position:relative}
[class*="round"] .image-container,[class*="circle"] .image-container,[class*="interactive"] .image-container,[class*="primary"] .image-container{width:100%!important;height:100%!important;margin:0!important;padding:0!important;border-radius:50%!important;overflow:hidden!important;display:flex!important;align-items:center!important;justify-content:center!important;position:absolute!important;top:0!important;left:0!important;z-index:1!important;box-shadow:none!important}
[class*="round"] .image-container img,[class*="circle"] .image-container img,[class*="interactive"] .image-container img,[class*="primary"] .image-container img{width:100%!important;height:100%!important;object-fit:cover!important;object-position:center!important;border-radius:0!important;box-shadow:none!important;margin:0!important;padding:0!important;max-width:none!important;display:block!important;border:none!important}
...
.template-section{margin:40px 0;padding:40px;background:rgba(255,255,255,0.1);border-radius:25px;border:3px dashed rgba(255,255,255,0.5);overflow-y:auto;overflow-x:hidden;max-height:90vh;min-height:200px;scroll-behavior:smooth}
...
.content-center{display:flex;flex-direction:column;align-items:center;justify-content:flex-start;min-height:100vh;padding:40px;width:100%;max-width:100%;box-sizing:border-box;overflow-x:hidden;overflow-y:auto;scroll-behavior:smooth}
.s{display:flex;flex-direction:column;align-items:center;justify-content:flex-start;min-height:100vh;padding:20px;width:100%;max-width:100%;box-sizing:border-box;overflow-x:hidden;overflow-y:auto;scroll-behavior:smooth}
.two-column{display:flex;align-items:flex-start;justify-content:space-between;max-width:1000px;margin:0 auto;gap:50px;padding:40px;width:100%;box-sizing:border-box;overflow-y:auto;overflow-x:hidden;max-height:90vh;min-height:300px;scroll-behavior:smooth}
...
@media (max-width:768px){.slide-title-main{font-size:min(52px,8vw)}.slide-title-secondary{font-size:min(36px,6vw)}.instruction-text{font-size:min(40px,7vw)}.simple-text{font-size:min(30px,5vw)}.giant-button{width:min(280px,75vw);height:min(280px,75vw);min-width:160px;min-height:160px;font-size:min(100px,16vw);border:min(8px,1.5vw) solid rgba(255,255,255,0.8)}.hero-image{width:320px;height:240px}.button-row{gap:20px}.two-column{flex-direction:column;gap:30px;max-height:none;overflow-y:visible}.template-section{max-height:none;overflow-y:visible}.audio-toggle{width:70px;height:70px;font-size:35px}.audio-status{font-size:14px}[class*="round"] .image-container,[class*="circle"] .image-container,[class*="interactive"] .image-container,[class*="primary"] .image-container{width:100%;height:100%}[class*="round"] .image-container img,[class*="circle"] .image-container img,[class*="interactive"] .image-container img,[class*="primary"] .image-container img{width:100%;height:100%}}
@media (max-width:480px){.slide-title-main{font-size:min(40px,9vw)}.slide-title-secondary{font-size:min(32px,7vw)}.instruction-text{font-size:min(32px,7vw)}.simple-text{font-size:min(26px,6vw)}.giant-button{width:min(220px,70vw);height:min(220px,70vw);min-width:140px;min-height:140px;font-size:min(80px,14vw);border:min(6px,1vw) solid rgba(255,255,255,0.8)}.hero-image{width:280px;height:210px}.template-section{padding:20px;margin:20px 0;max-height:none;overflow-y:visible}.audio-toggle{width:60px;height:60px;font-size:30px;top:15px;right:15px}.audio-status{font-size:12px;top:85px;right:15px}.two-column{max-height:none;overflow-y:visible}[class*="round"] .image-container,[class*="circle"] .image-container,[class*="interactive"] .image-container,[class*="primary"] .image-container{width:100%;height:100%}[class*="round"] .image-container img,[class*="circle"] .image-container img,[class*="interactive"] .image-container img,[class*="primary"] .image-container img{width:100%;height:100%}}
</style>
</head>
<body>
